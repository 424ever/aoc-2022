...
static struct aoc_sol day5_sol = {
	.name = "day5",
	.sol  = &day5_sol_func
};
...
void day5_sol_func (in_f, out_f, debug_out)
FILE *in_f;
FILE *out_f;
FILE *debug_out;
{
